...
#                signal = df1['injection_parameters']['l1_signal_whitened'][0:10000][()]
                ...
                strain = df1['injection_samples']['l1_strain'][()]                
                signal = df1['injection_parameters']['l1_signal_whitened'][()]
            
            
            if(self.data == 'test'):
                strain_1 = df1['injection_samples']['l1_strain'][()]
#                strain_2 = df2['injection_samples']['l1_strain'][0:25][()]
...
#                signal_2 = df2['injection_parameters']['l1_signal_whitened'][0:25][()]
...
#                signal = np.concatenate([signal_1,signal_2,signal_3,signal_4])                  
            ...
            if(noise_samples.shape is not None):
                ...
                if(self.data =='train'):
                    ...
                    noise_strain = df1['noise_samples']['l1_strain'][()]
                    noise_signal = df1['noise_parameters']['l1_signal'][()] 
...
#                    noise_strain = np.concatenate([noise_strain_1,noise_strain_2,noise_strain_3,noise_strain_4])
#                    noise_signal = np.concatenate([noise_signal_1,noise_signal_2,noise_signal_3,noise_signal_4])
